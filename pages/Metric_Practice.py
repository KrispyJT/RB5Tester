...
# # --- Bar Chart: Actuals by Category and Program ---
# st.header("📊 Actuals by Service Category and Program Type")

# actual_df = df.groupby(["Fiscal Year", "Service Category", "Program Type"])["Actual"].sum().reset_index()
...
#     title="Actuals by Service Category & Program Type (FY24 vs FY25)",
